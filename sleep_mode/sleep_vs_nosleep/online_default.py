...
# Run in sleep mode, command execution: python online_default.py sleep 
# Run in no sleep mode, command execution: python online_default.py nosleep
def main():
    ...
    try:
        if test_mode == 'sleep':
            print("=== CONFIG: Running in SLEEP MODE (Level 1) ===")
